                    ...
                    <form className="form" action="##" method="post" id="userProfileForm">
                        ...
                        <div className="form-group">
                            <div className="col-xs-6">
                                ...
                                <input type="date" className="form-control" name="dateofBirth" id="dateofBirth" placeholder="dateofBirth" title="enter your date of Birth if any." />
                            </div>
                        </div>
                        ...
                        <div className="form-group">
                            <div className="col-xs-6">
                                <label htmlFor="mobile"><h6>Japanese Skill</h6></label>
                                <input type="text" className="form-control" name="japaneseSkill" id="japaneseSkill" placeholder="enter Japanese Skill. e.g. N3" title="enter your japanese skill if any." />
                            </div>
                        </div>
                        ...
                        <div className="form-group">
                            <div className="col-xs-12">
                                ...
                                <input type="text" className="form-control" id="address" placeholder="enter address" title="enter a address" />
                            </div>
                        </div>

                        <div className="form-group">
                            <div className="col-xs-12">
                                <label htmlFor="deg"><h6>Degree and Major</h6></label>
                                <input type="text" className="form-control" name="deg" id="deg" placeholder="deg" title="enter your degree and major." />
                            </div>
                        </div>
